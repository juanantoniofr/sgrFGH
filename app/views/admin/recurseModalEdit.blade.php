  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group col-md-6" id="fe-aforomax">
  
          {{Form::label('aforomaximo', 'Aforo Máximo')}}
            <span id="error_aforomaximo" class="text-danger hidden spanerror">
              <i class="fa fa-exclamation-circle" aria-hidden="true"></i> 
              <span id='text_error'></span>
            </span>
            {{Form::text('aforomaximo','',array('class' => 'form-control'))}}
        </div>

        <div class="form-group col-md-6" id="fe-aforoexam">

          {{Form::label('aforoexamen', 'Aforo Examen')}}
            <span id="error_aforoexamen" class="text-danger hidden spanerror">
              <i class="fa fa-exclamation-circle" aria-hidden="true"></i>
              <span id='text_error'></span>
            </span>
            {{Form::text('aforoexamen','',array('class' => 'form-control'))}}
        </div>
        ...
        <div class="form-group">
          ...
          @foreach(Config::get('mediosdisponibles.medios') as $medio) 
            <label class="checkbox-inline">
              <input type="checkbox" name = "medios[]" value="{{$medio['codigo']}}" class="check_medios"> {{$medio['nombre']}}
            </label>
          @endforeach
        </div>        
        ...
        <div class="form-group">  
          ...
          {{Form::label('idgrupo', 'Seleccione Agrupación o..')}}
            ...
            <div id="error_nuevogrupo" class="text-danger hidden" >

              <i class="fa fa-exclamation-circle" aria-hidden="true"></i> 
              <b id="text_error_nuevogrupo"></b>
            </div>
