  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h3 class="modal-title"><i class="fa fa-institution fa-fw"></i> Añadir nueva titulación</h3>
      </div><!-- ./modal-header -->
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary" id ="botonSalvarNuevaTitulacion">
